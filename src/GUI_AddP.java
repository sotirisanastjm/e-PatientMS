...
public class GUI_AddP extends JFrame{
	...
	public GUI_AddP(){
		...
		save.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if(!name.getText().equals("Name") && !surname.getText().equals("Surname")&&
						!father.getText().equals("Father's name")&&
						!mother.getText().equals("Mother's name")&&
						!date.getText().equals("YYYY-MM-DD")&&
						!weight.getText().equals("Weight")&&
						!height.getText().equals("Height")&&
						!amka.getText().equals("Amka")&&
						!email.getText().equals("Email")&&
						!blood.getText().equals("Blood Type")) {
					String regex = "[0-9, /.]+",regex1 = "[0-9]+";
					if(amka.getText().matches(regex1)) {
						if(weight.getText().matches(regex)&& height.getText().matches(regex)){
							if(Double.valueOf(weight.getText())<999) {
								if(Double.valueOf(height.getText())<9) {
									try {
										con.setPatient(new Patient(name.getText(),surname.getText(),father.getText(),mother.getText(),
					...
					}else JOptionPane.showMessageDialog(null, "Please only number in at the amka section.. ");
